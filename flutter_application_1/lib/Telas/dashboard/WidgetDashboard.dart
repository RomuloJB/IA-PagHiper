                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Wrap(
                        ...
                        children: [
                          ...
                          _MetricCard(
                            label: "Média Capital",
                            value:
                                "R\$ ${mediaCapitalSocial.toStringAsFixed(2)}",
                            color: kPrimaryBlue,
                          ),
                        ],
                      ),
                      ...
                      Container(
                        ...
                        child: BarChart(
                          BarChartData(
                            ...
                            maxY:
                                (contratosPorMes.values.isNotEmpty)
                      ...
                      _SectionTitle(
                        title: "Distribuição de regimes tributários",
                      ),
                      Container(
                        height: 150,
                        padding: const EdgeInsets.all(8.0),
                      ...
                      Container(
                        ...
                        child:
                            tipoSocietarioDistribuicao.isEmpty
                                ? const Center(
                                  child: Text(
                                    "Nenhum dado disponível",
                                    style: TextStyle(color: kTextColor),
                                ...
                                : PieChart(
                                  PieChartData(
                                    sections:
                                        tipoSocietarioDistribuicao.entries
                                            .toList()
                                            .asMap()
                                            .entries
                                            .map((e) {
